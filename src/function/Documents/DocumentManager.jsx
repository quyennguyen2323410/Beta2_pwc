...
export default function DocumentManager() {
  ...
  // Mở tệp để xem (luôn mở xem phiên bản chính thức lưu trên Supabase)
  ...
  // Kéo nội dung mới nhất về ghi đè file hiện tại (không tăng version)
  ...
  // Mở thẳng trình soạn thảo trực tuyến trên tab mới
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="flex items-center gap-1 text-xs text-slate-500">
                  <Database size={13} /> Lưu trữ đám mây an toàn
                </span>
              ...
              <h1 className="mt-2 text-2xl md:text-3xl font-extrabold tracking-tight text-slate-900">
                Quản lý tài liệu & Soạn thảo trực tuyến
              </h1>
              <p className="mt-1 text-sm text-slate-500">
                Phân quyền truy cập • Lưu lịch sử phiên bản • Soạn thảo trực tuyến
              </p>
            </div>
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                title="Đồng bộ các nội dung vừa chỉnh sửa vào hệ thống"
          ...
          <div className="flex flex-wrap gap-1.5 rounded-2xl border border-slate-200 bg-white p-1.5 shadow-sm">
            {[
              ...
              <button
                ...
                className={`rounded-xl px-3.5 py-1.5 text-xs font-semibold transition ${filterType === tab.id
        ...
        <div className="overflow-hidden rounded-3xl border border-slate-200/80 bg-white shadow-sm">
          {loading ? (
            <div className="flex flex-col items-center justify-center py-20 text-slate-400">
              ...
              <p className="mt-3 text-sm font-medium">Đang tải danh sách tài liệu...</p>
            </div>
                        ...
                        <td className="py-4 pl-4 pr-6 text-right">
                          <div className="flex items-center justify-end gap-1.5">
                            ...
                            <button
                              ...
                              className="inline-flex items-center gap-1.5 rounded-xl bg-slate-800 px-3 py-1.5 text-xs font-semibold text-white shadow-sm transition hover:bg-slate-700 active:scale-95"
                            >
                              <Eye size={13} />
                              Xem
                            </button>

                            {/* Dành riêng cho DOCX: Nút Chỉnh sửa trực tuyến (chỉ người có quyền) */}
                            {doc.file_type === "docx" && canEdit && (
                              <button
                                type="button"
                                onClick={() => handleOpenWordEditor(doc)}
                                disabled={openingDocId === doc.id}
                                title="Mở trình soạn thảo trực tuyến"
                                className="inline-flex items-center gap-1.5 rounded-xl bg-blue-600 px-3.5 py-1.5 text-xs font-bold text-white shadow-sm transition hover:bg-blue-500 active:scale-95"
                              >
                                {openingDocId === doc.id ? (
                                  <>
                                    <RefreshCw size={13} className="animate-spin" />
                            ...
                            {/* Dành riêng cho DOCX: Nút Đồng bộ (chỉ người có quyền) */}
                            {doc.file_type === "docx" && canEdit && (
                              <button
                                type="button"
                                onClick={() => handleSyncSingle(doc)}
                                title="Lưu các thay đổi vừa chỉnh sửa vào hệ thống"
                                className="inline-flex items-center gap-1.5 rounded-xl border border-cyan-500/30 bg-cyan-500/10 px-3 py-1.5 text-xs font-bold text-cyan-400 transition hover:bg-cyan-500/20 active:scale-95 shadow-sm"
                              >
                                <RefreshCw size={13} />
                                Đồng bộ
                              </button>
